...
const Layout = () => {
  ...
  // AI floating button: vertical position (percentage), draggable up and down
  ...
  // AI floating button: dragging after pointer-down changes its vertical position
  ...
  return (
    <RegistryRefreshContext.Provider value={{ refreshing, handleRefresh }}>
      <RegistryPathContext.Provider value={registryPath}>
        ...
        />
        {/* Tiled container: when the AI panel is open the main page shrinks, side by side without overlap */}
        <div style={{ display: "flex", height: "100vh", overflow: "hidden" }}>
          ...
          >
          {/* Top header with a single uniform color (consistent across the row, fixed at the top) */}
          <div
          ...
          >
            {/* LOGO: fixed at the top, centered relative to the sidebar (sidebar width 240 / collapsed 64) */}
            <img
              src="/logo-fcis.svg"
              alt="FCIS"
              style={{
            ...
            {/* Left spacer: keeps the search box centered */}
            <div style={{ flex: 1 }} />
            ...
            {isAuthEnabled && user && (
              <>
                {/* Vertical divider between the action area and the user area */}
                <div
                  style={{
                    width: 1,
                    height: 20,
          ...
          {/* Below: left sidebar + content area */}
          ...
          />
          {/* AI floating button: fixed at the right edge, vertically centered, draggable; click to toggle the AI panel */}
          <div
            ref={aiBtnRef}
